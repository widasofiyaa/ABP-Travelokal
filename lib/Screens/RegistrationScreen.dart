...
import 'package:travelokals/Screens/Home.dart';
import 'package:travelokals/Screens/SignInPage.dart';
...
import 'package:travelokals/utils/forms.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          SizedBox(height: 10),
          BoldText("Hai", 30.0, kdarkBlue),
          NormalText("Let's Find Out", kdarkBlue, 30.0),
          SizedBox(
            height: 20,
          ),
